		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Christina&#x27;s Basic App",
									"targetURL": "#MyBasProject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MyBasProject-display": {
								"semanticObject": "MyBasProject",
								"action": "display",
								"description": "Christina&#x27;s Basic App",
								"title": "Christina&#x27;s Basic App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MyBasProject",
									"url": sap.ui.require.toUrl("MyBasProject")
								}
							}
						}
					}
